...
public class JdsToSortly {

   static Response  response;
   static ObjectMapper obj = new ObjectMapper();

   static GetAllSortlyItems getAllSortlyItems;

   static StringBuilder sb = new StringBuilder();

  static GetJdsInventory getJdsInventory = new GetJdsInventory();
    ...
    public static void updateManufacturerStock() throws JsonProcessingException {

        System.out.println("Data transfer has started");

        //Get all sortly data and find the ones with manufacturer sku
        ...
        System.out.println("Received data is being analyzed");
        ...
        System.out.println("Being Connected to JDS server");
        ...
        System.out.println("Updating inventory in Sortly");
